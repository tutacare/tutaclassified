                            ...
                            <div class="locations-list  list-filter">
                                ...
                                <ul class="browse-list list-unstyled long-list">
                                  @foreach($ads_city as $value)
                                    <li><a href="sub-category-sub-location.html"> {{$value->city}} </a></li>
                                  @endforeach
                                </ul>
                            </div>
                            <!--/.locations-list-->
                    ...
                    <div class="category-list">
                        <div class="tab-box ">
                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                <li class="active"><a href="#allAds">{{$category->category}}
                                  <i class="fa fa-angle-double-right"></i> {{$sub_category}} <span
                        ...
                        <div class="listing-filter">
                            <div class="pull-left col-xs-10">
                                ...
                                @foreach($ads_sub_cat as $value)
                                  <div class="col-xs-2">
                                  <li><a href="/category/{{$category->slug}}/{{$value->slug}}/sub">{{$value->name}}</a></li>
                                </div>
                                @endforeach
                              </ul>
                                </div>
                            ...
                            <div class="item-list">
                                ...
                                <div class="col-sm-7 add-desc-box">
                                    <div class="add-details">
                                        <h5 class="add-title"><a href="/ads/{{$value->product_slug}}">
