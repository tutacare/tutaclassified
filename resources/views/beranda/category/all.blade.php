                            ...
                            <div class="locations-list  list-filter">
                                ...
                                <ul class="browse-list list-unstyled long-list">
                                  @foreach($ads_city as $value)
                                    <li><a href="{{url()->current()}}/{{$value->slug}}/city"> {{$value->city}} </a></li>
                                  @endforeach
                                </ul>
                            </div>
                            <!--/.locations-list-->
                    ...
                    <div class="category-list">
                        <div class="tab-box ">
                            ...
                            <ul class="nav nav-tabs add-tabs" role="tablist">
                                <li class="active"><a href="#allAds" role="tab" data-toggle="tab">Semua Kategori <span
                                        class="badge">{{$ads_all_count}}</span></a></li>
                            </ul>
